            ...
            <div class="dt-content-wrapper">
                ...
                <div class="dt-content">
                    ...
                    <div class="dt-page__header">
                        <h1 class="dt-page__title">Liste contact</h1>
                    </div>
                    <!-- /page header -->
                                ...
                                <div class="dt-card__body">
                                    ...
                                    <?php
                                      if(isset($_GET['resultat'])){
                                        if ($_GET['resultat'] ==' email supprimier'){

                                        
                                      ?>
                                    <div class="alert alert-danger" role="alert">
                                        <strong>email supprimier</strong> 
                                    ...
                                    ?>
                                        <table id="data-table" class="table table-striped table-bordered table-hover">
                                            ...
                                            <?php
                                              ...
                                              ?>
                                            <tr class="gradeX">
                                                <td><?php echo $res['nomcontact']?></td>
                                                <td><?php echo $res['email']?></td>
                                                <td><?php echo $res['sujet']?></td>
                                                <td><?php echo $res['message']?></td>
                                                <td>
                                                   <a href="controller/supp-contact.php?id=<?php echo $res['idcontact']?>" type="button" class="btn btn-danger">supprimer </a> </td>
                                            </tr>
