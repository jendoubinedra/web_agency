...
<!-- Mirrored from microtheme.co/html/osfins/single-project.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 08 Feb 2022 12:39:17 GMT -->
<head>
  <meta charset="utf-8">
  ...
  <div class="site-wrapper">
              ...
              <div class="d-flex align-items-center">
                <nav class="header-menu">
                  <ul class="navigation-menu header-navigation-menu">
                    ...
                    <li class="active-page-menu"><a href="#">Pages</a>
                      <ul class="submenu-inner">
                        <li><a href="portfolio.html">Projects</a>
                          <ul class="submenu-inner">
                            <li class="active-page-menu"><a href="single-project.html">Projects Details</a></li>
                          </ul>
                        </li>
    ...
    <div class="project-single-wrapper">
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
            <div class="project-details-widget">
              <img src="assets/img/project-image.jpg" alt="" class="img-fluid">
              <div class="project-summary">
                <div class="row no-gutters">
                  <div class="col-md-3">
                    <div class="ps-block">
                      <div class="pd-title">Client</div>
                      <div class="pd-content">Michale Hardson</div>
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="ps-block">
                      <div class="pd-title">Date</div>
                      <div class="pd-content">24 December, 2020</div>
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="ps-block">
                      <div class="pd-title">Category</div>
                      <div class="pd-content">Business, App</div>
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="ps-block">
                      <div class="pd-title">Service</div>
                      <div class="pd-content">App Development</div>
                    </div>
                  </div>
                </div>
              </div>
              <h2 class="text-uppercase">Digital Product</h2>
              ...
              <h3 class="text-uppercase">Project Challenges</h3>
              <p class="mb-60">Neque porro est qui dolorem ipsum quia quaed inventore veritatis et quasi architecto
                beatae vitae dicta sunt explicabo. Aelltes port lacus quis enim var sed efficitur turpis gilla sed sit
                amet finibus eros. Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
              <div class="list-item">
                <ul>
                  ...
                  <li><span class="list-icon"><i class="flaticon-check-mark"></i></span> Velit esse cillum dolore eu
                    fugiat nulla pariatur.</li>
                </ul>
              </div>
            </div>
            <div class="related-porolio">
              <div class="text-center">
                <span class="section-intro">Recent Portfolio</span>
                <h2 class="section-title">Similar Projects</h2>
              </div>
              <div class="related-portfolio-carousel swiper-container">
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <div class="portfolio-item">
                      <img src="assets/img/portfolio-1.jpg" alt="" class="img-fluid">
                      <a href="single-portfolio.html" class="portfolio-more"><i
                          class="flaticon-right-arrow-angle"></i></a>
...
<!-- Mirrored from microtheme.co/html/osfins/single-project.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 08 Feb 2022 12:39:18 GMT -->
</html>