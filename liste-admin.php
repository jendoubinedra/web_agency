            ...
            <div class="dt-content-wrapper">
                ...
                <div class="dt-content">
                    ...
                    <div class="dt-page__header">
                        <h1 class="dt-page__title">liste admin</h1>
                    </div>
                    <!-- /page header -->
                                ...
                                <div class="dt-card__body">
                                    ...
                                    <div class="table-responsive">
                                      ...
                                      if(isset($_GET['resultat'])){
                                        if ($_GET['resultat'] ==' ajouter admin'){
                                     ...
                                     ?>
                                        <table id="data-table" class="table table-striped table-bordered table-hover">
                                            ...
                                            <tr class="gradeX">
                                                ...
                                                <td><a href="mailto:<?php echo $donne['email']?>"> <?php echo $donne['nom']?></a></td>
                                                
                                                
                                                <td>
                                                
                                                <a href="modif-admin.php?id=<?php echo $donne['id']?>"  class="btn btn-success">modifier</a>
                                                    
                                                    <a href="controller/supp-admin.php?id=<?php echo $donne['id']?>"  class="btn btn-danger">supprimer</a></td>
                                              </tr>
                                            <?php }?>
