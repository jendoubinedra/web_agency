...
<!-- Mirrored from microtheme.co/html/osfins/portfolio.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 08 Feb 2022 12:39:16 GMT -->
<head>
  <meta charset="utf-8">
              ...
              <div class="d-flex align-items-center">
                <nav class="header-menu">
                  <ul class="navigation-menu header-navigation-menu">
                    ...
                    <li class="active-page-menu"><a href="#">Portfolio</a>
                      <ul class="submenu-inner">
                        <li class="active-page-menu"><a href="portfolio.php">Projects</a>
                        </li> 
                      </ul>
                    </li>
                    </li>
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="portfolio-filters">
              <ul>
                <li data-role="button" data-filter="all">tous les projets </sup></li>
                <li data-role="button" data-filter=".industry">developpement web</sup></li>
                <li data-role="button" data-filter=".factory">developpement mobile </sup></li>
               
              </ul>
            </div>
            <div class="portfolio-gallary row">
              <div class="col-lg-4 mix industry">
                <div class="portfolio-item">
                  <img src="assets/img/portfolio-1.jpg" alt="" class="img-fluid">
                  <a href="single-portfolio.php" class="portfolio-more"><i class="flaticon-right-arrow-angle"></i></a>
              ...
              <div class="col-lg-4 mix factory">
                <div class="portfolio-item">
              ...
              <div class="col-lg-4 mix business">
                <div class="portfolio-item">
              ...
              <div class="col-lg-4 mix industry web">
                <div class="portfolio-item">
              ...
              <div class="col-lg-4 mix business web">
                <div class="portfolio-item">
              ...
              <div class="col-lg-4 mix ">
                <div class="portfolio-item">
                  ...
                  <a href="single-portfolio.html" class="portfolio-more"><i class="flaticon-right-arrow-angle"></i></a>
                  <div class="portfolio-item-overlay">
                    <div class="portfolio-block-category">
                      <a href="#">Design</a>
                    </div>
...
<!-- Mirrored from microtheme.co/html/osfins/portfolio.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 08 Feb 2022 12:39:17 GMT -->
</html>