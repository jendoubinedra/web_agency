...
$id=$_GET['id'];
$req=$bdd->query("select * from categorie where idc=$id");
$res=$req->fetch();
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="dt-content-wrapper">
                ...
                <div class="dt-content">
                    ...
                    <div class="dt-page__header">
                        <h1 class="dt-page__title">modifier categories</h1>
                    </div>
                    <!-- /page header -->
                        ...
                        <div class="col-xl-6">
                            ...
                            <div class="dt-card">
                                ...
                                <div class="dt-card__body">
                                    ...
                                    <!-- Form -->
                                    <form action="controller/modifcat.php?id=<?php echo $res['idc']?>" method ="post">
                                        <!-- Form Group -->
                                        <div class="form-group">
                                            <label for="nom">nom categories</label>
                                            <input type="text" class="form-control" id="nom"
                                                   aria-describedby="emailHelp1"
                                                   name="nomc"   placeholder="Enter nom categories" value="<?php echo $res['nomc']?>"  >
