...
<!-- Mirrored from microtheme.co/html/osfins/home-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 08 Feb 2022 12:39:10 GMT -->
<head>
  <meta charset="utf-8">
  ...
  <div class="site-wrapper">
                  ...
                  <ul class="navigation-menu header-navigation-menu">
                    <li class="active-page-menu"><a href="index-2.php">Accueil</a>
                      <ul class="submenu-inner">
                        ...
                        <li class="active-page-menu"><a href="home-2.php">Home 2</a></li>
                      </ul>
                    </li>
                    ...
                    <li><a href="blog.php">Recreutement</a>
                      <ul class="submenu-inner">
                ...
                <div class="header-contact-search d-flex justify-content-between">
                  <div class="menubar-contact d-flex align-items-center">
                    ...
                    <div class="mc-details">
                      <span class="mc-phone">92 888 666 0000</span>
                      <span class="mc-title">Mon - Fri: 10:00 am to 6:00 pm</span>
                    </div>
                  </div>
    ...
    <div class="slider-widget">
      <div class="container-full">
        <div class="row">
          <div class="col-sm-12">
            <div class="slider-two swiper-container">
              <div class="swiper-wrapper">
                <div class="slider-one-slide swiper-slide">
                  <div class="slide-bg" data-background="assets/img/slide-3.jpg"></div>
                  <div class="slider-wrapper">
                    <div class="slider-content">
                      <div class="container">
                        <div class="row">
                          <div class="col-sm-12 col-lg-10">
                            <h2 class="slide-heading">We’re Providing
                              Effective Business
                              Solutions</h2>
                            <div class="slide-descriptions">
                              Exercitation llamco laboris nis aliquip sed conseqrure dolorn repreh velit excepteur duis
                              aute.
                            </div>
                ...
                <div class="slider-one-slide swiper-slide">
                  <div class="slide-bg" data-background="assets/img/slide-4.jpg"></div>
                  <div class="slider-wrapper">
                    <div class="slider-content">
                      <div class="container">
                        <div class="row">
                          <div class="col-sm-12 col-lg-10">
                            <h2 class="slide-heading">Best Digital
                              Startup Agency</h2>
                            <div class="slide-descriptions">
                              Exercitation llamco laboris nis aliquip sed conseqrure dolorn repreh velit excepteur duis
                              aute.
        ...
        <div class="row">
          <div class="col-sm-12 text-right">
            <div class="experience-block">
              ...
              <div class="ex-year count-number">36+</div>
    ...
    <div class="services-section-two">
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
            <span class="section-intro">We Provide digital services</span>
            <h2 class="section-title white-text">Services We’re offering</h2>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-12 col-lg-4">
            <div class="service-block-2">
              <div class="service-thumb">
                <img src="assets/img/web-service.jpg" alt="" class="img-fluid">
              </div>
              <div class="service-details">
                <h2 class="service-block-title"><a href="#">Website
                    Development</a></h2>
                <div class="service-anchor">
                  <a href="#">Read more</a>
                </div>
              </div>
            </div>
          ...
          <div class="col-sm-12 col-lg-4">
            <div class="service-block-2">
              ...
              <div class="service-details">
                <h2 class="service-block-title"><a href="#">Digital
                    Marketing</a></h2>
                <div class="service-anchor">
                  <a href="#">Read more</a>
                </div>
          ...
          <div class="col-sm-12 col-lg-4">
            <div class="service-block-2">
              ...
              <div class="service-details">
                <h2 class="service-block-title"><a href="#">AppliCation
                    development</a></h2>
                <div class="service-anchor">
                  <a href="#">Read more</a>
                </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-5 mb-xs-30 mb-md-30">
            <div class="styled-image-1">
              <img src="assets/img/about-3.jpg" alt="" class="img-fluid rounded-circle">
            </div>
          </div>
          <div class="col-lg-6 offset-lg-1">
            ...
            <div class="about-content-2 mb-40">
              <p>Lorem ipsum dolor sit amet, consectetur notted adipisicing elit sed do eiusmod tempor incididunt ut
                labore et dolore magna aliqua lonm andhn. Aenean tincidunt id mauris id auctor. Donec at ligula lacus.
                Nulla dignissim mi quis neque interdum.</p>
            </div>
            <div class="bar-box">
              <div class="d-flex justify-content-between align-items-center">
                <h5 class="skill-title">Digital Consultancy</h5>
              </div>
              <div class="bar-line">
                <div class="bar-line-active" data-percent="80%">
            ...
            <div class="bar-box">
              <div class="d-flex justify-content-between align-items-center">
                <h5 class="skill-title">Graphic Design</h5>
              </div>
              <div class="bar-line">
                <div class="bar-line-active" data-percent="66%">
                  <div class="count-text">66%</div>
                </div>
              </div>
            </div>
            <div class="copany-info-box mt-60">
              <div class="d-flex align-items-center">
                <div class="com-logo">
        ...
        <div class="row">
          <div class="col-lg-5">
            <div class="about-inner-content">
              <span class="section-intro">get to know us</span>
              <h2 class="section-title white-text">Best Digital Service
                Provider</h2>
              <div class="about-content-3 dark-text mb-40">
                ...
                form, lipsum is simply free text by injected humou or randomised words even believable.
              </div>
              <div class="row">
                <div class="col-md-3 col-lg-4 mb-xs-30">
                  <img src="assets/img/about-5.jpg" alt="" class="img-fluid">
                </div>
                <div class="col-md-9 col-lg-8">
                  <div class="list-item white-text">
                    <ul>
                      <li><span class="list-icon"><i class="flaticon-check-mark"></i></span> Offering high quality
                        business solutions</li>
                      <li><span class="list-icon"><i class="flaticon-check-mark"></i></span> World's leading digital
                        business corporation</li>
                      <li><span class="list-icon"><i class="flaticon-check-mark"></i></span> Powerfull business product
                        strategy</li>
                      <li><span class="list-icon"><i class="flaticon-check-mark"></i></span> Award winning projects</li>
                    </ul>
                  </div>
                </div>
              </div>
          ...
          <div class="col-lg-6 offset-lg-1">
            <div class="about-image-4" data-background="assets/img/about-4.jpg">
            </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 text-center">
            <span class="section-intro">Our team members</span>
            <h2 class="section-title">Experts Ready To serve</h2>
          </div>
        </div>
        <div class="row mb-n-200">
          <div class="col-sm-12">
                ...
                <div class="swiper-slide">
                  <div class="team-member">
                    ...
                    <div class="member-meta">
                      ...
                      <span class="member-designation">designer</span>
    ...
    <div class="portfolio-section-2 white-bg">
      <div class="container">
        <div class="row">
          <div class="col-sm-12 text-center">
            <span class="section-intro">Recent Portfolio</span>
            <h2 class="section-title">Our Quality Work</h2>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-12">
    ...
    <div class="testimonials-section-2" data-background="assets/img/testimonials-bg.png">
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
            ...
            <div class="testimonials-slider swiper-container mb-n-200">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
    ...
    <div class="map-section">
      <div class="map-outer">
        <div class="map-canvas" data-zoom="14" data-lat="-37.817136" data-lng="144.955772" data-type="roadmap"
          data-hue="#ffc400" data-icon-path="assets/img/map-pin.png" data-title="Osfins Inc."
          data-content="121 King Street, Melbourne, Victoria-3000,  Australia">
        </div>
      </div>
    </div>
    <div class="cta-bar">
...
<!-- Mirrored from microtheme.co/html/osfins/home-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 08 Feb 2022 12:39:14 GMT -->
</html>