...
<!-- Mirrored from microtheme.co/html/osfins/team.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 08 Feb 2022 12:39:18 GMT -->
<head>
  <meta charset="utf-8">
  ...
  <div class="site-wrapper">
          ...
          <ul class="header-navigation-menu mobile-menu">
            ...
            <li class="active-page-menu"><a href="#">Pages</a>
              <ul class="submenu-inner">
                ...
                <li class="active-page-menu"><a href="team.html">Team</a></li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
            ...
            <h1 class="page-title">Our Team Members</h1>
          </div>
        </div>
      </div>
    </div>
    <div class="welcome-widget">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6">
            <span class="welcome-intro">Experts have easy solutions</span>
            <h2 class="welcome-heading">We have highly professionals</h2>
          </div>
          <div class="col-md-6">
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 text-center">
            ...
            <h2 class="section-title">Experts Ready To surve</h2>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-12">
