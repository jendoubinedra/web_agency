...
<!-- Mirrored from microtheme.co/html/osfins/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 08 Feb 2022 12:39:18 GMT -->
<head>
  <meta charset="utf-8">
  ...
  <div class="site-wrapper">
                  ...
                  <ul class="navigation-menu header-navigation-menu">
                    ...
                    <li class="active-page-menu"><a href="#">Pages</a>
                      <ul class="submenu-inner">
                        ...
                        <li class="active-page-menu"><a href="faq.html">FAQ</a></li>
    ...
    <div class="welcome-widget">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6">
            <span class="welcome-intro">Find all your answers</span>
            <h2 class="welcome-heading">Freequently asked questions</h2>
          </div>
          <div class="col-md-6">
