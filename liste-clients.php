            ...
            <div class="dt-content-wrapper">
                ...
                <div class="dt-content">
                    ...
                    <div class="dt-page__header">
                        <h1 class="dt-page__title">liste clients</h1>
                    </div>
                    <!-- /page header -->
                                ...
                                <div class="dt-card__body">
                                    ...
                                    <?php
                                      if(isset($_GET['resultat'])){
                                        if ($_GET['resultat'] =='ajouter un client'){
                                     ...
                                     ?>
                                        <table id="data-table" class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody>
                                              ...
                                              ?>
                                            <tr class="gradeX">
                                                <td><?php echo $result['nomclient']?></td>
                                                <td><?php echo $result['nom_entreprise']?></td>
                                                <td><?php echo $result['matricule_fiscal']?></td>
                                                <td><a href="mailto:<?php echo $result['email_c']?>"> <?php echo $result['email_c']?></a></td>
                                                <td><?php echo $result['login_c']?></td>
                                                <td><?php echo $result['adresse']?></td>
                                                <td><?php echo $result['tel']?></td>
                                                <td>
                                                <a href="modifier-client.php?id=<?php echo $result['id']?>" class="btn btn-success">modifier</a>
                                                <a href="controller/supp-client.php?id=<?php echo $result['id']?>"  class="btn btn-danger">supprimer</a></td>
