                                    ...
                                    <form action="controller/ajout-services.php" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nom"
                                                   ...
                                                   placeholder="Enter nom"  name="noms" required>
                                        ...
                                        <!-- /form group -->
                                         ...
                                         <div class="form-group">
                                            ...
                                            <textarea  
                                              rows="5" cols="33" class="form-control" name="desc">
                                            </textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="cat"
                                                   placeholder="entre categorie" name="categorie" required>
                                        </div>
                                        <!-- /form group -->
                                        <!-- Form Group -->
