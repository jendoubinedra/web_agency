                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="login_c" accesskey="N" class="sr-only"><span class="required">*</span> login</label>
                      <input  type="text" id="login_c" size="30" value="" placeholder="tapez votre login" name="login_c" required/>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="password" accesskey="E" class="sr-only"><span class="required">*</span> password</label>
                      <input  type="password" id="tel" size="30" value="" placeholder="entre mot de passe"  name="password" required/>
                    </div>
                  </div>
                  </div>  
                  <div class="col-md-6">
                    <button type="submit" class="form-submit-btn theme-btn" id="submit">connexion</button>
                  </div>
                </div>
              </form>
            </div>
