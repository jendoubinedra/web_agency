...
function __construct($nomclient,$nom_entreprise,$matricule_fiscal,$email_c,$login_c,$adresse,$tel){
...
include('../includes/connect_db.php');
		...
		$req = $bdd->exec("INSERT INTO `client`(`nomclient`, `nom_entreprise`, `matricule_fiscal`, `email_c`,`login_c`,`adresse`,`tel`) values('$this->nomclient','$this->nom_entreprise','$this->matricule_fiscal','$this->email_c','$this->login_c','$this->adresse','$this->tel')");
