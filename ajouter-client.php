            ...
            <div class="dt-content-wrapper">
                ...
                <div class="dt-content">
                    ...
                    <div class="dt-page__header">
                        <h1 class="dt-page__title">ajouter client</h1>
                    </div>
                    <!-- /page header -->
                        ...
                        <div class="col-xl-6">
                            ...
                            <div class="dt-card">
                                ...
                                <div class="dt-card__body">
                                    ...
                                    <!-- Form -->
                                    <form action="controller/ajout-client.php" method="post">
                                        <!-- Form Group -->
                                        <div class="form-group">
                                            <label for="nomclient">nom</label>
                                            <input type="text" class="form-control" id="nomclient"
                                                   aria-describedby="emailHelp1"
                                                   placeholder="Enter nom" name="nomclient" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nom_entreprise"
                                                   aria-describedby="emailHelp1"
                                                   placeholder="Enter nom d'entreprise" name="nom_entreprise" required>
                                        ...
                                        <!-- /form group -->
                                          ...
                                          <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="matricule_fiscal"
                                                   aria-describedby="emailHelp1"
                                                   placeholder="Enter matricule fiscal"  name="matricule_fiscal" required>
                                            
                                        </div>
                                         <!-- Form Group -->
                                         <div class="form-group">
                                            <label for="email_c">email</label>
                                            <input type="text" class="form-control" id="email_c"
                                                   aria-describedby="emailHelp1"
                                                   placeholder="Enter login" name="email_c">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="login_c"
                                                   aria-describedby="emailHelp1"
                                                   placeholder="Enter login" name="login_c">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="tel"
                                                   placeholder="entre tel " name="tel" required>
                                        </div>
                                        <!-- /form group -->
                                         <!-- Form Group -->
