            ...
            <div class="dt-content-wrapper">
                ...
                <div class="dt-content">
                    ...
                    <div class="dt-page__header">
                        <h1 class="dt-page__title">modifier client</h1>
                    </div>
                    <!-- /page header -->
                        ...
                        <div class="col-xl-6">
                            ...
                            <div class="dt-card">
                                ...
                                <div class="dt-card__body">
                                    ...
                                    <!-- Form -->
                                    <form action="controller/modifclient.php?id=<?php echo $result['id']?>" method="post"> 
                                        <!-- Form Group -->
                                        <div class="form-group">
                                            <label for="nom">nom</label>
                                            <input type="text" class="form-control" id="nom"
                                                   aria-describedby="emailHelp1"
                                                   placeholder="Enter nom"  name="nomclient"  value="<?php echo $result['nomclient']?>" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="email-1"
                                                   aria-describedby="emailHelp1"
                                                   placeholder="Enter nom d'entreprise" name="nom_entreprise" value="<?php echo $result['nom_entreprise']?>" required>
                                            
                                        </div>
                                        <!-- /form group -->
                                          <!-- Form Group -->
                                          <div class="form-group">
                                            <label for="nom">matricule fiscal</label>
                                            <input type="text" class="form-control" id="email-1"
                                                   aria-describedby="emailHelp1"
                                                   placeholder="Enter matricule fiscal" name="matricule_fiscal"  value="<?php echo $result['matricule_fiscal']?>" required>
                                        ...
                                        <!-- /form group -->
                                          ...
                                          <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="login"
                                                   aria-describedby="emailHelp1"
                                                   placeholder="Enter login" name="email_c" vale="<?php echo $result['email_c']?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="login"
                                                   aria-describedby="emailHelp1"
                                                   placeholder="Enter login" name="login_c" value="<?php echo $result['login_c']?>">
                                           
                                        </div>
                                        <!-- /form group -->
                                        <!-- Form Group -->
                                        <div class="form-group">
                                            <label for="adressz">adresse</label>
                                            <input type="text" class="form-control" id="adresse"
                                                   aria-describedby="emailHelp1"
                                                   placeholder="Enter adresse" name="adresse" value="<?php echo $result['adresse'] ?>">
                                        ...
                                        <!-- Form Group -->
                                        <div class="form-group">
                                            <label for="telephpne">tel</label>
                                            <input type="text" class="form-control" id="telephpne"
                                                   placeholder="entre tel " name="tel"  value="<?php echo $result['tel']?>" required>
                                        </div>
                                        <!-- /form group -->
                                        <!-- Form Group -->
