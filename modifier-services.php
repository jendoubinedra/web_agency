...
$id=$_GET['id'];
$req=$bdd->query("select * from service  where ids=$id");
$res=$req->fetch();
?>
 <!DOCTYPE html>
<html lang="en">
            ...
            <div class="dt-content-wrapper">
                ...
                <div class="dt-content">
                    ...
                    <div class="dt-page__header">
                        <h1 class="dt-page__title">modifier services</h1>
                    </div>
                    <!-- /page header -->
                        ...
                        <div class="col-xl-6">
                            ...
                            <div class="dt-card">
                                ...
                                <div class="dt-card__body">
                                    ...
                                    <!-- Form -->
                                    <form action="controller/modifservices.php?id=<?php echo $res['ids']?>" method="post">
                                        <!-- Form Group -->
                                        <div class="form-group">
                                            <label for="nom">nom</label>
                                            <input type="text" class="form-control" id="nom"
                                                   aria-describedby="emailHelp1"
                                                   placeholder="Enter nom" name="noms"  value="<?php echo $res['noms']?>" required>
                                        ...
                                        <!-- /form group -->
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="des"
                                                   aria-describedby="emailHelp1"
                                                   placeholder="Enter description" name="desc" value="<?php echo $res['desc']?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" id="img"
                                                   aria-describedby="emailHelp1"
                                                   placeholder="Enter image" name="image" value="<?php echo $res['image']?>" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="prix"
                                                   aria-describedby="emailHelp1"
                                                   placeholder="Enter prix" name="prix" value=" <?php echo $res['prix']?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="cat"
                                                   placeholder="entre categorie"  name="categorie" value="<?php echo $res['categorie']?>" required>
                                        </div>
                                        <!-- /form group -->
                                        <!-- Form Group -->
