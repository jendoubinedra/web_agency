            ...
            <div class="dt-content-wrapper">
                ...
                <div class="dt-content">
                    ...
                    <div class="dt-page__header">
                        <h1 class="dt-page__title">liste categories</h1>
                    </div>
                    <!-- /page header -->
                                ...
                                <div class="dt-card__body">
                                    ...
                                    <?php
                                      if(isset($_GET['resultat'])){
                                        if ($_GET['resultat'] =='ajouter categories'){
                                    ...
                                    <?php
                                     ...
                                     <?php
                                      if(isset($_GET['resultat'])){
                                        if ($_GET['resultat'] =='modif categorie'){
                                    ...
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                     ...
                                     ?>
                                        <?php
                                      if(isset($_GET['resultat'])){
                                        if ($_GET['resultat'] =='supp categories'){
                                     ...
                                     ?>
                                        <table id="data-table" class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody>
                                              ...
                                              ?>
                                            <tr class="gradeX">
                                                <td><?php echo $res['nomc']?></td>
                                           
                                                <td>
                                                  <a href="modifier-categories.php?id=<?php echo $res['idc']?>"  class="btn btn-success">modifier</a>
                                                <a href="controller/supp-categorie.php?id=<?php echo $res['idc']?>"  class="btn btn-danger">supprimer</a></td>
                                            </tr>
